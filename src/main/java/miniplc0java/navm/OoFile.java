...
import miniplc0java.navm.instruction.Instruction;
...
public class OoFile {
    ...
    public OoFile() {
        ...
        this.addFunction(new FuncSymbol("_start", SymbolType.FUNCTION, DataType.VOID, _START_POSITION, new Pos(0,0)));
    }
    ...
    public int addFunction(FuncSymbol funcSymbol) {
        ...
        DataType dType = funcSymbol.getDatatype();
        int returnSlots = dType==DataType.VOID? 0:1;
        //获取参数长度
