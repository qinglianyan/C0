...
public enum ErrorCode {
    ...
    /*add*/
    InvalidString, DuplicateArgs, InvalidType, InvalidVoid, InvalidOpVoid, NotMatchedType, callArgNotMatched, ReturnTypeNotMatched, NotAllBranchReturn, UnExpectToken, InvalidExpr, AssignNotToVar, NoMain, InvalidChar
}
